...
project = u'Xena Documentation'
copyright = u'2022, Xena Networks'
author = u'Xena Networks'
title = u'Documentation'

# The full version, including alpha/beta/rc tags.
release = get_version("../../xena_docs/__init__.py")

# The short X.Y version.
version = get_short_version("../../xena_docs/__init__.py")
...
htmlhelp_basename = 'xena_docs_doc'
...
latex_documents = [(master_doc, 'xena_docs_doc.tex', title, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'xena_docs_doc', title, [author], 1)
]
